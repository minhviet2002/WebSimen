...
function btnClick3(){
    var boxAdds = document.querySelectorAll('.container__introduce-six-body-list-cart-link');
    boxAdds.forEach(function(boxAdd,index){
        boxAdd.onclick = function(e){
            // console.log(hm[index].querySelector('.productTitleName').innerText)
            e.preventDefault();
            // console.log(e.target.closest('.container__introduce-six-body'))
            alert('Products already in the cart')
            var productItem =   e.target.closest('.container__introduce-six-body');
            var productItemName = productItem.querySelector('.container__introduce-six-body-heading-link').innerText;
            var productItemPrice = productItem.querySelector('.container__introduce-six-body-list-price span').innerText;
            var productItemImg = productItem.querySelector('.container__introduce-six-img-item').src;
            var myCartItem = new Array(productItemName, productItemPrice,productItemImg);
...
// Icon 
const containerIconTwoMobile = document.querySelector('.container__introduce-two-mobile');
containerIconTwoMobile.onclick = function(){
    const containerIconTwoMoblieList = document.querySelector('.container__introduce-two-mobile-list');
    containerIconTwoMoblieList.classList.toggle('block');
}
const containerIconFourChoose = document.querySelector('.container__introduce-four-choose');
containerIconFourChoose.onclick = function(){
    const containerIconFourChooseList = document.querySelector('.container__introduce-four-choose-list');
    containerIconFourChooseList.classList.toggle('block');
}
//  tabmenu click icon 
...
var item7Header = document.querySelector('.header__sidebar-item7');
...
item7Header.onclick = function(e){
    e.preventDefault();
    window.location.assign('payment.html');
}
